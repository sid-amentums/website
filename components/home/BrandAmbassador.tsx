  ...
  return (
    <section className="overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-2">
        <Reveal
          variant="up"
          className="flex flex-col justify-center bg-red px-6 py-16 md:px-16 md:py-24"
        >
          <div>
            <div className="mb-3.5 text-[11px] font-medium uppercase tracking-wide text-white/70">
              Brand Ambassador
            </div>
            <h2 className="mb-5 font-serif text-3xl leading-tight text-w md:text-5xl">
              Davinder Singh
              <br />
              <em className="not-italic text-ink">Kang.</em>
            </h2>
            <p className="mb-6 max-w-md text-[clamp(15px,1.5vw,17px)] font-light leading-relaxed text-white/80">
            ...
            <div className="inline-flex w-fit items-center gap-2 rounded-[10px] border border-white/20 bg-w px-[18px] py-3">
